            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  IconButton(onPressed: () => Get.toNamed('/cart',
              ...
              itemBuilder: (context, index) => Padding(
                ...
                child: Card(
                  ...
                  child: Column(
                    children: [
                      Image.network(
                        'https://img.alicdn.com/tfs/TB1e.XyReL2gL0jSZFmXXc7iXXa-990-400.png',
                        fit: BoxFit.cover,
                      ),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        ...
                        children: [
                          ...
                          Padding(
                            padding: const EdgeInsets.all(8.0),
                            child: ElevatedButton(onPressed: () => cart.addtoCart(controller.products[index]),
                            child: Text(
                              'Shop Now',
                              style: TextStyle(
                                fontSize: 12.0,
